type PlanetSituation = "Habitado" | "Habitável" | "Inábitavel" | "Inexplorado"

type PlanetCoordinates = [number, number, number, number]

type Planet = {
   name: string,
   cordinates: PlanetCoordinates,
...
function addPlanet(name:string, cordinates: PlanetCoordinates, situation: PlanetSituation) {
    planets.push({
        name,
        cordinates,
        situation,
...
function findPlanets(name: string) {
